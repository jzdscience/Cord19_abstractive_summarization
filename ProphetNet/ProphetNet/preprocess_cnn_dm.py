...
preocess('train.article', 'cnndm/prophetnet_tokenized/all.src', keep_sep=False)
preocess('train.summary', 'cnndm/prophetnet_tokenized/all.tgt', keep_sep=True, max_len=128)
